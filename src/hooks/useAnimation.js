...
import { generateRandomDuration, generateRandomLocation } from "../components/randomGenerator";
import { generateRandomOffsets } from "../components/randomGenerator";
...
const useAnimation = () => {
  ...
  return { animation1, animation2, animation3, animation4, animation5, animation6, animation7, animation8, animation9 };
};
